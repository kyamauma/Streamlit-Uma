...
data = pd.read_csv("D:\sampledata.csv")
data.columns

#importing dataset from mysql
engine=sqlalchemy.create_engine('mysql+pymysql://root:qwerty@localhost:3306/project_69')
data=pd.read_sql_table("sampledata",engine)
